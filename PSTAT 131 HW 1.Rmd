...
In mechanistic models, bias of model would increase while predictors are added into the model but variance of model would also increase meanwhile. Thus to trade-off this problem, the irrelevant predictors should be removed.
